...
export default function Page() {
  ...
  return (
    <main className=" m-auto w-auto md:w-[55rem]">
      <h1 className=" mt-10 text-center text-2xl text-yellow-600 font-bold md:text-3xl">
        Discover several cryptocurrencies
      </h1>
          ...
          <div className=" mt-10 text-white">
            ...
            {cryptoList.data.map((crypto) => (
              <Link href={`/crypto-currency/${crypto.id}`} key={crypto.id}>
                <div className="grid grid-cols-6 border-b text-[12px] border-gray-700 py-2 font-semibold md:text-[15px] md:hover:bg-[#ffffff28] duration-300 md:px-1">
                  ...
                  <div
                    className={` flex flex-row ${
                      Math.floor(crypto.price_change_percentage_24h * 100) /
                        10 >
                      0
                        ? "text-green-700"
                        : "text-red-700"
